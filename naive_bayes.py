...
def naive_bayes(training_file, test_file, verbose=False):
    # Training Step
    ...
    print_training_summary(class_summary, verbose)
    ...
    print_test_summary(prediction_set, test_labelset, verbose)
